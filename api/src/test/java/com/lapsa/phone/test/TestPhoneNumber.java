...
public class TestPhoneNumber {
	...
	try {
	    test(" 8 (7272)-530721 ", new PhoneNumber(PhoneCCode.KZ, "727", "2530721"), "+7 (727) 2530721");
	...
	try {
	    test(" 8 (963)-777-79 79", new PhoneNumber(PhoneCCode.RU, "963", "7777979"), "+7 (963) 7777979");
	} catch (PhoneFormatException e) {
	    fail(e.getMessage());
	}
    }
	...
	try {
	    test(" 8 (727)2-530721 ", new PhoneNumber(PhoneCCode.KZ, "727", "2530721"), "+7 (727) 2530721");
	} catch (PhoneFormatException e) {
	    fail(e.getMessage());
	}
    }
	...
	test(" 8 (2272)-530721 ", new PhoneNumber(PhoneCCode.KR, "272", "530721"), "+82 (272) 530721");
    }
